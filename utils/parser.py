...
def parse_args():
    ...
    parser.add_argument('--dataset', nargs='?', default='cora',
                        help='Choose a dataset from {Blog,dblp,survey，citeseer,,amazon0302,,survey,wiki-Vote,filmtrust,ml-100k,gowalla, yelp2018,amazon-book }')
    parser.add_argument('--split', nargs='?', default='/split0',
                        help='Split dataset')
    parser.add_argument('--is_socia', type=bool, default=False,
                        help='Ture: Datasets have socia information, False: Only u-i')
    ...
    parser.add_argument('--embed_size', type=int, default=64,
                        help='Embedding size.')
    parser.add_argument('--layer_size', nargs='?', default='[128,64]',
